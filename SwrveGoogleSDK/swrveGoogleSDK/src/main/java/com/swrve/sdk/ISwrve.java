...
public interface ISwrve extends ISwrveBase<ISwrve, SwrveConfig> {
	 ...
	 * 			Required, cannot be empty.
	 * @param dataSignature
	 * 			The purchase data received from Google Play.
	 * 			Required, cannot be empty.
	 * @param dataSignature
	 *          The signature for the purchase data
	 *          Required, cannot be empty.
	 */
	 ...
	 * 			Required, cannot be empty.
	 * @param productPrice
	 * 			price of the product in real money. Note that this is the price
	 ...
	 * 			Required, cannot be empty.
	 * @param rewards
	 * 			SwrveIAPRewards object containing any in-app currency and/or additional
