...
/**
 * View factory used to create visual representation of Swrve
 * messages.
 */
public class SwrveMessageViewFactory {
	 ...
	 * @param context
	 * 		  Android context to build the view.
	 * @param message
	 *        message to be rendered.
	 * @param orientation
	 * 	      orientation of the format to be rendered. It can also be Both
	 *        to select any format available in the message.
	 * @param installButtonListener
	 * 		  install button listener to process clicks on the view
	 * @param customButtonListener
	 * 		  custom button listener to process clicks on the view
	 * @param firstTime
	 * 		  indicates if it is the first time the message is displayed.
