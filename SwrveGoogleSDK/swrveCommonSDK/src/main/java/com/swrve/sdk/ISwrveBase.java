...
public interface ISwrveBase<T, C extends SwrveConfigBase> {
	 ...
	 * 
	 * @param context
	 *            your activity or application context
	 * @param appId
	 *            your app id in the Swrve dashboard
	 * @param apiKey
	 *            your app api_key in the Swrve dashboard
     ...
     *            your app api_key in the Swrve dashboard
     * @param userId
     *            your unique user id for the application
     * @param config
     *            your SwrveConfig options
     * @throws IllegalArgumentException 
     */
	 ...
	 * 
	 * @param name
	 *            the name of the event in question. The character '.' is used
	 *            as grouping syntax.
	 */
	 ...
	 *            as grouping syntax.
	 * @param payload
	 *            a dictionary of key-value pairs to be supplied with this named
	 ...
	 * 
	 * @param item
	 *            unique name of the purchased item
	 * @param currency
	 *            currency in Swrve to be used for this purchase. This currency
	 *            must be declared in the Swrve dashboard before calling this
	 *            function. If this currency is not declared this event will be
	 *            rejected.
	 * @param cost
	 *            cost of the item in units of 'currency'
	 * @param quantity
	 ...
	 * 
	 * @param givenCurrency
	 *            currency in Swrve to be used for this gift. This currency must
	 ...
	 * 
	 * @param attributes
	 *            key-value pairs of properties of the user. Typical values
	 ...
	 * @param productId
	 *            Unique product identifier for the item bought. This should
	 *            match the Swrve resource name. Required, cannot be empty.
	 * @param productPrice
	 *            The price (in real money) of the product that was purchased.
	 *            Note: this is not the price of the total transaction, but the
	 *            per-product price. Must be greater than or equal to zero.
	 * @param currency
	 *            real world currency used for this transaction. This must be an
	 ...
	 *            match the Swrve resource name. Required, cannot be empty.
	 * @param productPrice
	 *            price of the product in real money. Note that this is the
	 ...
	 *            cannot be empty.
	 * @param rewards
	 *            SwrveIAPRewards object containing any in-app currency and/or
	 ...
	 * 
	 * @param message
	 *            message that was shown to the user for the first time in this
	 *            session.
	 */
