...
/*
 * This object implements an active Swrve campaign containing messages targeted for the current device and user id.
 */
public class SwrveCampaign {
	...
	protected int id;
	// The Talk controller for this campaign
	protected SwrveBase<?, ?> talkController;
	// Next message to be shown when possible
	protected int next;
	 ...
	 * This will check the event against the triggers.
	 * @param eventName
	 ...
	 * @param now
	 *            device time
	 * @param campaignReasons
	 *            write the reason a campaign is not shown in the map
	 * @return SwrveMessage message setup to the given trigger or null
	 *         otherwise.
	 */
	 ...
	 * @param campaignData
	 *            JSON data containing the campaign details.
	 * @param assetsQueue
	 *            Set where to save the resources to be loaded
	...
	/**
	 * Increment by one the impressions.
	 */
	...
	/**
	 * Create the settings to be saved from this campaign.
	 * 
	 ...
	 * 
	 * @param settings
	 *            JSONObject containing the campaign settings.
	 * @throws JSONException
	 */
	 ...
	 * 
	 * @param messageFormat
	 *            SwrveMessageFormat shown to the user.
	 */
