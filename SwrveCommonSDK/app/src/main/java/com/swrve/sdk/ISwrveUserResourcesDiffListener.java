...
public interface ISwrveUserResourcesDiffListener {
	 ...
	 * 
	 * @param oldResourcesValues
	 *            the old values of AB Tested resources represented as a map of
	 *            the form uid->(attribute_name->attribute_value).
	 * @param newResourcesValues
	 *            the new values of AB Tested resources represented as a map of
	 *            the form uid->(attribute_name->attribute_value).
	 * @param resourcesAsJSon
